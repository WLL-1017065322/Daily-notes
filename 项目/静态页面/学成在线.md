...
logo：宽高，浮动；a链接：宽高，背景图片，text-indent（文字） overflow

nav：float，margin-left，li：float，hei，line-hei，margin-left  a：block,hei,font-size,padding

:hover:border-bottom

.search:wid,hei,border,padding-left,float;botton:wid,hei,border,outline,float,bgdurl
